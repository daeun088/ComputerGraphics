...
static const std::array<std::array<float, 2>, 17> outline = {{{{0.00f, 0.03f}}, {{0.14f, 0.046f}}, {{0.197f, 0.13f}}, {{0.195f, 0.222f}}, {{0.194f, 0.37f}}, {{0.267f, 0.54f}}, {{0.270f, 0.74f}}, {{0.170f, 0.86f}}, {{0.00f, 0.887f}}, {{-0.170f, 0.86f}}, {{-0.270f, 0.74f}}, {{-0.267f, 0.54f}}, {{-0.194f, 0.37f}}, {{-0.195f, 0.222f}}, {{-0.197f, 0.13f}}, {{-0.14f, 0.046f}}, {{0.00f, 0.03f}}}};
...
void drawTuningKnobsOnTrapezoid(bool isRight)
{
    ...
    if (!isRight)
        std::reverse(zPos.begin(), zPos.end()); // 왼쪽일 땐 z 순서를 반대로
...
void drawGuitar()
{
    ...
    for (size_t i = 0; i < smooth.size(); ++i)
    {
        ...
        glTexCoord2f(u, 0);
        glVertex3f(smooth[i][0], +halfThick, smooth[i][1]);
        glTexCoord2f(u, 1);
        glVertex3f(smooth[i][0], -halfThick, smooth[i][1]);
    }
    glEnd();
